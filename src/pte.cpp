...
template <typename PTT, unsigned L, unsigned B, typename I, typename O>
Paging::Permissions Pte<PTT,L,B,I,O>::lookup (IAddr v, OAddr &p, unsigned &o, Memattr::Cacheability &ca, Memattr::Shareability &sh)
{
    unsigned l = L;
