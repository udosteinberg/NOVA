...
Console_uart_sio::Regs Console_uart_sio::probe (pci_t bdf, unsigned e, unsigned s)
{
    ...
    if (static_cast<uint16_t>(Pci::read (bdf, Pci::Cfg::Reg32::DID_VID)) == 0x8086 && Pci::read (bdf, Pci::Cfg::Reg32::CCP_RID) >> 8 == 0x60100) {

        constexpr uint16_t port[8] { 0x3f8, 0x2f8, 0x220, 0x228, 0x238, 0x2e8, 0x338, 0x3e8 };

        auto const reg { Pci::read (bdf, Pci::Cfg::Reg32 { 0x80 }) };
