...
{
    if (!Hip::feature (Hip_arch::Feature::SMMU_DMA)) [[unlikely]] {
        s = Status::BAD_FTR;
        return nullptr;
    }
...
Sm *Pd::create_sm (Status &s, Space_obj *obj, unsigned long sel, Kobject::Subtype t, uintptr_t v)
{
    auto const o { Sm::create (s, this, t, v) };
