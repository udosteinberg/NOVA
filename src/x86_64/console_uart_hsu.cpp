...
INIT_PRIORITY (PRIO_CONSOLE) Console_uart_hsu Console_uart_hsu::uart0 { Pci::bdf (0, 26, 0) };
INIT_PRIORITY (PRIO_CONSOLE) Console_uart_hsu Console_uart_hsu::uart1 { Pci::bdf (0, 26, 1) };
INIT_PRIORITY (PRIO_CONSOLE) Console_uart_hsu Console_uart_hsu::uart2 { Pci::bdf (0, 26, 2) };
