...
void Ec::sys_assign_pci()
{
    ...
    uint64 phys; unsigned o, rid; Memattr::Cacheability ca; Memattr::Shareability sh;
    if (EXPECT_FALSE (!Pd::current->Space_hst::lookup (r->dev(), phys, o, ca, sh) || (rid = Pci::phys_to_rid (phys)) == ~0U)) {
