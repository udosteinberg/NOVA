...
template <typename T>
Status Space_mem<T>::delegate (Space_hst const *hst, unsigned long const ssb, unsigned long const dsb, unsigned const ord, unsigned const pmm, Memattr::Cacheability ca, Memattr::Shareability sh)
{
