...
{
    auto vect_info { Vmcs::read<uint32_t> (Vmcs::Encoding::ORG_EVENT_IDENT) };
...
void Ec_arch::handle_vmx()
{
    ...
    self->regs.gst_sys.kernel_gs_base = Msr::read (Msr::Register::IA32_KERNEL_GS_BASE);
    ...
    auto reason { Vmcs::read<uint32_t> (Vmcs::Encoding::EXI_REASON) & BIT_RANGE (7, 0) };
