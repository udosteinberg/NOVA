...
void Acpi_table_fadt::parse() const
{
    ...
    trace (TRACE_FIRM, "ACPI: Version %u.%u Profile %u Flags %#x", revision, minor_version & BIT_RANGE (3, 0), pm_profile, fflg);
