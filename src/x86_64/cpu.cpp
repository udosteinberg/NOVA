...
void Cpu::init()
{
    ...
    Pd_kern::nova().Space_mem::update (CPU_GLOBL_DATA + id * PAGE_SIZE, phys, 0, Paging::Permissions (Paging::G | Paging::W | Paging::R), ca, sh);
    Hpt::set_lps (feature (FEAT_1GB_PAGES) ? 3 : 2);
