...
INIT_PRIORITY (PRIO_CONSOLE) Console_uart_apb Console_uart_apb::uart0 { bdf0, did0 };
INIT_PRIORITY (PRIO_CONSOLE) Console_uart_apb Console_uart_apb::uart1 { bdf1, did1 };
INIT_PRIORITY (PRIO_CONSOLE) Console_uart_apb Console_uart_apb::uart2 { bdf2, did2 };
