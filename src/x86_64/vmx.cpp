...
void Vmcs::init (uintptr_t gsp, uintptr_t hsp, uintptr_t cr3, uint64_t apic, uint16_t vpid)
{
    ...
    if (Cpu::feature (Cpu::Feature::PAT))
        write (Encoding::HOST_PAT, Msr::read (Msr::Register::IA32_PAT));

    if (Cpu::feature (Cpu::Feature::LM))
        write (Encoding::HOST_EFER, Msr::read (Msr::Register::IA32_EFER));

    if (Cpu::feature (Cpu::Feature::CET_SS) || Cpu::feature (Cpu::Feature::CET_IBT))
        write (Encoding::HOST_S_CET, Msr::read (Msr::Register::IA32_S_CET));

    if (Cpu::feature (Cpu::Feature::CET_SS)) {
        write (Encoding::HOST_SSP, reinterpret_cast<uintptr_t>(&SSTK_TOP));
        write (Encoding::HOST_SSP_TABLE_ADDR, Msr::read (Msr::Register::IA32_INTERRUPT_SSP_TABLE_ADDR));
    }
...
void Vmcs::init()
{
    if (!Cpu::feature (Cpu::Feature::VMX) || (Msr::read (Msr::Register::IA32_FEATURE_CONTROL) & 0x5) != 0x5)
        return;

    if (!Acpi::resume) {

        // Basic VMX Information
        bool const ctrl = (basic = Msr::read (Msr::Register::IA32_VMX_BASIC)) & BIT64 (55);

        // Pin-Based Controls
        constexpr auto hyp_pin { Pin::PIN_VIRT_NMI | Pin::PIN_NMI | Pin::PIN_EXTINT };
        auto const vmx_pin { Msr::read (ctrl ? Msr::Register::IA32_VMX_TRUE_PIN : Msr::Register::IA32_VMX_CTRL_PIN) };
        ...
        auto const vmx_ent { Msr::read (ctrl ? Msr::Register::IA32_VMX_TRUE_ENT : Msr::Register::IA32_VMX_CTRL_ENT) };
        ...
        auto const vmx_exi_pri { Msr::read (ctrl ? Msr::Register::IA32_VMX_TRUE_EXI : Msr::Register::IA32_VMX_CTRL_EXI_PRI) };
        ...
        auto const vmx_exi_sec { has_exi_sec() ? Msr::read (Msr::Register::IA32_VMX_CTRL_EXI_SEC) : 0 };
        ...
        auto const vmx_cpu_pri { Msr::read (ctrl ? Msr::Register::IA32_VMX_TRUE_CPU : Msr::Register::IA32_VMX_CTRL_CPU_PRI) };
        ...
        constexpr auto hyp_cpu_sec_clr { Cpu_sec::CPU_NOTIFICATION | Cpu_sec::CPU_BUS_LOCK | Cpu_sec::CPU_EPC_VIRT | Cpu_sec::CPU_ENCLV | Cpu_sec::CPU_TSC_SCALING | Cpu_sec::CPU_SPP | Cpu_sec::CPU_PASID | Cpu_sec::CPU_PML | Cpu_sec::CPU_ENCLS | Cpu_sec::CPU_VMCS_SHADOW | Cpu_sec::CPU_VMFUNC | Cpu_sec::CPU_VIRT_INTR | Cpu_sec::CPU_VIRT_X2APIC };
        constexpr auto hyp_cpu_sec_set { Cpu_sec::CPU_MBEC | Cpu_sec::CPU_URG | Cpu_sec::CPU_VPID | Cpu_sec::CPU_EPT };
        auto const vmx_cpu_sec { has_cpu_sec() ? Msr::read (Msr::Register::IA32_VMX_CTRL_CPU_SEC) : 0 };
        ...
        constexpr auto hyp_cpu_ter_clr { Cpu_ter::CPU_SPEC_CTRL | Cpu_ter::CPU_GPAW | Cpu_ter::CPU_IPI_VIRT | Cpu_ter::CPU_EPT_VPW | Cpu_ter::CPU_EPT_PW | Cpu_ter::CPU_HLAT };
        constexpr auto hyp_cpu_ter_set { 0 };
        auto const vmx_cpu_ter { has_cpu_ter() ? Msr::read (Msr::Register::IA32_VMX_CTRL_CPU_TER) : 0 };
        ...
        ept_vpid = Msr::read (Msr::Register::IA32_VMX_EPT_VPID);
        ...
        fix_cr0_set =  Msr::read (Msr::Register::IA32_VMX_CR0_FIXED0);
        fix_cr0_clr = ~Msr::read (Msr::Register::IA32_VMX_CR0_FIXED1);
        fix_cr4_set =  Msr::read (Msr::Register::IA32_VMX_CR4_FIXED0);
        fix_cr4_clr = ~Msr::read (Msr::Register::IA32_VMX_CR4_FIXED1);
