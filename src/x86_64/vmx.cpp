...
void Vmcs::init (uintptr_t rsp, uintptr_t cr3, uint16 vpid)
{
...
void Vmcs::init()
{
    ...
    if (!Acpi::resume) {
        ...
        bool ctrl = (basic = Msr::read (Msr::Register::IA32_VMX_BASIC)) & BIT64 (55);

        // Pin-Based Controls
        constexpr auto hyp_pin { Pin::PIN_VIRT_NMI | Pin::PIN_NMI | Pin::PIN_EXTINT };
        auto vmx_pin { Msr::read (ctrl ? Msr::Register::IA32_VMX_TRUE_PIN : Msr::Register::IA32_VMX_CTRL_PIN) };
        ...
        auto vmx_ent { Msr::read (ctrl ? Msr::Register::IA32_VMX_TRUE_ENT : Msr::Register::IA32_VMX_CTRL_ENT) };
        ...
        auto vmx_exi_pri { Msr::read (ctrl ? Msr::Register::IA32_VMX_TRUE_EXI : Msr::Register::IA32_VMX_CTRL_EXI_PRI) };
        ...
        auto vmx_exi_sec { has_exi_sec() ? Msr::read (Msr::Register::IA32_VMX_CTRL_EXI_SEC) : 0 };
        exi_sec = hyp_exi_sec & vmx_exi_sec;

        // Primary VM-Execution Controls
        constexpr auto hyp_cpu_pri { Cpu_pri::CPU_SECONDARY | Cpu_pri::CPU_MSR_BITMAP | Cpu_pri::CPU_IO_BITMAP | Cpu_pri::CPU_IO | Cpu_pri::CPU_TERTIARY | Cpu_pri::CPU_HLT };
        auto vmx_cpu_pri { Msr::read (ctrl ? Msr::Register::IA32_VMX_TRUE_CPU : Msr::Register::IA32_VMX_CTRL_CPU_PRI) };
        ...
        auto vmx_cpu_sec { has_cpu_sec() ? Msr::read (Msr::Register::IA32_VMX_CTRL_CPU_SEC) : 0 };
        ...
        cpu_ter_clr = has_cpu_ter() ? Msr::read (Msr::Register::IA32_VMX_CTRL_CPU_TER) : 0;
