...
Ec::Ec (Space_obj *obj, Space_hst *hst, Space_pio *pio, mword, void (*f)(), cpu_t c, uintptr_t e, uintptr_t u, uintptr_t s) : Kobject (Kobject::Type::EC, u ? (f ? Kobject::Subtype::EC_GLOBAL : Kobject::Subtype::EC_LOCAL) : Kobject::Subtype::EC_VCPU_REAL), cont (f), regs (obj, hst, pio), pd (nullptr), cpu (c), glb (!!f), evt (e), timeout (this)
{
