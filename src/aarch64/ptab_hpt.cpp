...
void *Hptp::map (OAddr p, bool w)
{
    ...
    c.update (MMAP_CPU_TMAP,     p,     Hpt::bpl, Paging::Permissions ((w ? Paging::W : 0) | Paging::R), Memattr::Cacheability::MEM_WB, Memattr::Shareability::INNER);
    c.update (MMAP_CPU_TMAP + s, p + s, Hpt::bpl, Paging::Permissions ((w ? Paging::W : 0) | Paging::R), Memattr::Cacheability::MEM_WB, Memattr::Shareability::INNER);
