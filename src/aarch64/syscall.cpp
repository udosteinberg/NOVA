...
void Ec::sys_ctrl_pt()
{
    ...
    trace (TRACE_SYSCALL, "EC:%p %s PT:%#lx ID:%#lx MTD:%#x", static_cast<void *>(current), __func__, r->pt(), r->id(), r->mtd().val());
