...
bool Utcb_arch::assign_spaces (Cpu_regs &c, Space_obj const *obj) const
{
    ...
    if (!cap_gst.validate (Capability::Perm_sp::ASSIGN, Kobject::Subtype::GST)) [[unlikely]]
        return false;
