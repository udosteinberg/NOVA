...
void Hip::build (uint64 root_s, uint64 root_e)
{
    ...
    trace (TRACE_ROOT, "INFO: NOVA: %#llx-%#llx", nova_p_addr, nova_e_addr);
    trace (TRACE_ROOT, "INFO: MBUF: %#llx-%#llx", mbuf_p_addr, mbuf_e_addr);
    trace (TRACE_ROOT, "INFO: ROOT: %#llx-%#llx", root_p_addr, root_e_addr);
