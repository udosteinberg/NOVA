...
bool Acpi_table_madt::parse_entry (Controller::Type t) const
{
    ...
    while (ptr + sizeof (list_t) <= end) {
        ...
        switch (s->type()) {
            case Controller::Type::GICD: static_cast<Controller_gicd const *>(s)->parse(); break;
            case Controller::Type::GICR: static_cast<Controller_gicr const *>(s)->parse(); break;
            case Controller::Type::GICC: static_cast<Controller_gicc const *>(s)->parse(); break;
            case Controller::Type::GITS: static_cast<Controller_gits const *>(s)->parse(); break;
            default: break;
        }
    }
...
bool Acpi_table_madt::parse() const
{
    ...
    return parse_entry (Controller::Type::GICC) &
