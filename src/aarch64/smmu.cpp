...
bool Smmu::conf_smg (uint8 smg)
{
    ...
    write (ctx, Ctx_Array64::TTBR0, dma->get_phys());
    ...
    write (ctx, GR1_Array32::CBAR,  dma->get_sdid() & BIT_RANGE (7, 0));
...
void Smmu::invalidate (Sdid sdid)
{
    write (GR0_Register32::TLBIVMID, sdid & BIT_RANGE (15, 0));
