...
Smmu::Smmu (Board::Smmu const &cfg) : List (list), config (cfg)
{
    ...
    trace (TRACE_SMMU, "SMMU: %#010llx %#lx r%up%u NC:%u S1:%u S2:%u NTS:%u SMG:%u CTX:%u SID:%u-bit Mode:%u",
           config.mmio, smmu_size, idr7 >> 4 & BIT_RANGE (3, 0), idr7 & BIT_RANGE (3, 0), nc,
