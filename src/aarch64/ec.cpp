...
void Ec::root_invoke()
{
    ...
    current->regs.p0() = *reinterpret_cast<uintptr_t *>(Kmem::sym_to_virt (&__boot_p0));
    current->regs.p1() = *reinterpret_cast<uintptr_t *>(Kmem::sym_to_virt (&__boot_p1));
    current->regs.p2() = *reinterpret_cast<uintptr_t *>(Kmem::sym_to_virt (&__boot_p2));
    ...
    current->pd->Space_mem::update (hip_addr, Kmem::ptr_to_phys (Hip::hip), 0, Paging::Permissions (Paging::K | Paging::U | Paging::R), Memattr::Cacheability::MEM_WB, Memattr::Shareability::INNER);
