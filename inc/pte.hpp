...
class Pte
{
    public:
        ...
        {
            return Buddy::ptr_to_phys (walk (0, l, true, nc));
        }

        Paging::Permissions lookup (IAddr, OAddr &, unsigned &, Memattr::Cacheability &, Memattr::Shareability &);
    ...
    protected:
        ...
        Pte (OAddr p, OAddr s, bool nc)
        {
            ...
            if (nc)
                Cache::clean_dcache (this, PAGE_SIZE);
        }
