...
class Uefi final
{
    ...
    private:
        ...
        struct Bsv_table
        {
            ...
            SEC_INIT [[nodiscard]] bool valid() const { return header.signature == Signature::u64 ("BOOTSERV") && header.size == sizeof (*this); }
        ...
        struct Sys_table
        {
            ...
            SEC_INIT [[nodiscard]] bool valid() const { return header.signature == Signature::u64 ("IBI SYST") && header.size == sizeof (*this); }
        };
