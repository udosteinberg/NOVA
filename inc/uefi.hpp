...
class Uefi final
{
    ...
    private:
        ...
        struct Bsv_table final
        {
            ...
            Status (EFICALL *get_memory_map)(uintptr_t *, Memory_desc *, uintptr_t *, uintptr_t *, uint32_t *);     // 7.2.3
        ...
        class Graphics_output_protocol final
        {
            public:
                ...
                SEC_INIT bool select_mode (Info &);
            ...
            private:
                ...
                Status (EFICALL *query_mode)(Graphics_output_protocol const *, uint32_t, uintptr_t *, Mode_info const **);      // 12.9.2.1
