...
{
    static constexpr Cpu cpu[8] { { 0x000 }, { 0x100 }, { 0x200 }, { 0x300 }, { 0x400 }, { 0x500 }, { 0x600 }, { 0x700 } };
    static constexpr Tmr tmr[2] { { 0x0, 0x8 }, { 0x3, 0x8 } };
    static constexpr Gic gic[4] { { 0x17a00000, 0x10000 }, { 0x17a60000, 0x100000 }, { 0, 0 }, { 0, 0 } };
    static constexpr Uart uart { Debug::Subtype::SERIAL_GENI, 0xa90000, 0 };
