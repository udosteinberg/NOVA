...
#define RAM_BASE    0x80000000  // 0x80000000 - 0x27fffffff
...
struct Board
{
    ...
    static constexpr struct Cpu { uint64_t id; } cpu[8] { { 0x000 }, { 0x100 }, { 0x200 }, { 0x300 }, { 0x400 }, { 0x500 }, { 0x600 }, { 0x700 } };
    static constexpr struct Tmr { unsigned ppi, flg; } tmr[2] { { 0x0, 0x8 }, { 0x3, 0x8 } };
    static constexpr struct Gic { uint64_t mmio, size; } gic[4] { { 0x17a00000, 0x10000 }, { 0x17a60000, 0x100000 }, { 0, 0 }, { 0, 0 } };
    static constexpr struct Uart { Debug::Subtype type; uint64_t mmio; unsigned clock; } uart { Debug::Subtype::SERIAL_GENI, 0xa90000, 0 };
    static constexpr struct Smmu_v2 { uint64_t mmio; struct { unsigned spi, flg; } glb[1], ctx[64]; } smmu_v2[1]
    {   {   0x15000000,
            {   { 0x041, 0x4 }, },
