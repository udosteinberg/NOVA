...
class Console_uart_mmio_mini final : private Console_uart_mmio
{
    private:
        ...
        bool tx_busy() override final { return !(read (Register32::MU_STAT) & BIT (9)); }
        bool tx_full() override final { return  (read (Register32::MU_STAT) & BIT (5)); }
        void tx (uint8 c) override final { write (Register32::MU_IO, c); }
    ...
    protected:
        explicit Console_uart_mmio_mini (Hpt::OAddr p, unsigned c) : Console_uart_mmio (c) { mmap (p); }
