...
class Npt : public Pte<Npt, 3, 9, uint64, uint64>
{
    ...
    private:
        ...
        {
            return !(pm & (Paging::Permissions::XS | Paging::Permissions::XU | Paging::Permissions::W | Paging::Permissions::R)) ? 0 :
                     ATTR_K   * !!(pm &  Paging::Permissions::K)                             |
                     ATTR_nX1 *  !(pm & (Paging::Permissions::XS | Paging::Permissions::XU)) |
                     ATTR_W   * !!(pm &  Paging::Permissions::W)                             |
                     ATTR_R   * !!(pm &  Paging::Permissions::R)                             |
        ...
        static Paging::Permissions page_pm (OAddr a)
        {
            return Paging::Permissions (!a ? 0 :
                                      !!(a & ATTR_K)   *  Paging::Permissions::K  |
                                       !(a & ATTR_nX1) * (Paging::Permissions::XS | Paging::Permissions::XU) |
