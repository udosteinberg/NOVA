...
class Fpu final
{
    ...
    public:
        ...
        static void disable()
        {
            // Ensure disabling completes before any subsequent FPU instructions
            asm volatile ("msr cptr_el2, %x0; isb" : : "r" (Cpu::cptr | CPTR_TFP));
        ...
        static void enable()
        {
            // Ensure enabling completes before any subsequent FPU instructions
            asm volatile ("msr cptr_el2, %x0; isb" : : "r" (Cpu::cptr));
