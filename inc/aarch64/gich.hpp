...
class Gich
{
    ...
    private:
        ...
        static inline auto read  (Register32 r)             { return *reinterpret_cast<uint32 volatile *>(DEV_GLOBL_GICH + static_cast<unsigned>(r)); }
        static inline auto read  (Array32 r, unsigned n)    { return *reinterpret_cast<uint32 volatile *>(DEV_GLOBL_GICH + static_cast<unsigned>(r) + n * sizeof (uint32)); }

        static inline void write (Register32 r, uint32 v)          { *reinterpret_cast<uint32 volatile *>(DEV_GLOBL_GICH + static_cast<unsigned>(r)) = v; }
        static inline void write (Array32 r, unsigned n, uint32 v) { *reinterpret_cast<uint32 volatile *>(DEV_GLOBL_GICH + static_cast<unsigned>(r) + n * sizeof (uint32)) = v; }

        DEFINE_SYSREG_RW (el2_ap0r0,    S3_4_C12_C8_0);
        DEFINE_SYSREG_RW (el2_ap0r1,    S3_4_C12_C8_1);
        DEFINE_SYSREG_RW (el2_ap0r2,    S3_4_C12_C8_2);
        DEFINE_SYSREG_RW (el2_ap0r3,    S3_4_C12_C8_3);
        DEFINE_SYSREG_RW (el2_ap1r0,    S3_4_C12_C9_0);
        DEFINE_SYSREG_RW (el2_ap1r1,    S3_4_C12_C9_1);
        DEFINE_SYSREG_RW (el2_ap1r2,    S3_4_C12_C9_2);
        DEFINE_SYSREG_RW (el2_ap1r3,    S3_4_C12_C9_3);
        DEFINE_SYSREG_RW (el2_hcr,      S3_4_C12_C11_0);
        DEFINE_SYSREG_RO (el2_vtr,      S3_4_C12_C11_1);
        DEFINE_SYSREG_RO (el2_misr,     S3_4_C12_C11_2);
        DEFINE_SYSREG_RO (el2_eisr,     S3_4_C12_C11_3);
        DEFINE_SYSREG_RO (el2_elrsr,    S3_4_C12_C11_5);
        DEFINE_SYSREG_RW (el2_vmcr,     S3_4_C12_C11_7);
        DEFINE_SYSREG_RW (el2_lr0,      S3_4_C12_C12_0);
        DEFINE_SYSREG_RW (el2_lr1,      S3_4_C12_C12_1);
        DEFINE_SYSREG_RW (el2_lr2,      S3_4_C12_C12_2);
        DEFINE_SYSREG_RW (el2_lr3,      S3_4_C12_C12_3);
        DEFINE_SYSREG_RW (el2_lr4,      S3_4_C12_C12_4);
        DEFINE_SYSREG_RW (el2_lr5,      S3_4_C12_C12_5);
        DEFINE_SYSREG_RW (el2_lr6,      S3_4_C12_C12_6);
        DEFINE_SYSREG_RW (el2_lr7,      S3_4_C12_C12_7);
        DEFINE_SYSREG_RW (el2_lr8,      S3_4_C12_C13_0);
        DEFINE_SYSREG_RW (el2_lr9,      S3_4_C12_C13_1);
        DEFINE_SYSREG_RW (el2_lr10,     S3_4_C12_C13_2);
        DEFINE_SYSREG_RW (el2_lr11,     S3_4_C12_C13_3);
        DEFINE_SYSREG_RW (el2_lr12,     S3_4_C12_C13_4);
        DEFINE_SYSREG_RW (el2_lr13,     S3_4_C12_C13_5);
        DEFINE_SYSREG_RW (el2_lr14,     S3_4_C12_C13_6);
        DEFINE_SYSREG_RW (el2_lr15,     S3_4_C12_C13_7);
    ...
    public:
        static inline unsigned num_apr CPULOCAL { 0 };
        static inline unsigned num_lr  CPULOCAL { 0 };
        ...
        static void load (uint64 const (&lr)[16], uint32 const (&ap0r)[4], uint32 const (&ap1r)[4], uint32 const &hcr, uint32 const &vmcr)
        {
            if (Gicc::mode == Gicc::Mode::REGS) {
                ...
                write (Register32::VMCR, static_cast<uint32>(vmcr));
                write (Register32::HCR,  static_cast<uint32>(hcr));
            }
        }
        ...
        static void save (uint64 (&lr)[16], uint32 (&ap0r)[4], uint32 (&ap1r)[4], uint32 &hcr, uint32 &vmcr, uint32 &elrsr)
        {
            if (Gicc::mode == Gicc::Mode::REGS) {
                ...
                switch (num_apr) {
                    default:
                    case  4: ap0r[3] = static_cast<uint32>(get_el2_ap0r3()); ap1r[3] = static_cast<uint32>(get_el2_ap1r3()); FALLTHROUGH;
                    case  3: ap0r[2] = static_cast<uint32>(get_el2_ap0r2()); ap1r[2] = static_cast<uint32>(get_el2_ap1r2()); FALLTHROUGH;
                    case  2: ap0r[1] = static_cast<uint32>(get_el2_ap0r1()); ap1r[1] = static_cast<uint32>(get_el2_ap1r1()); FALLTHROUGH;
                    case  1: ap0r[0] = static_cast<uint32>(get_el2_ap0r0()); ap1r[0] = static_cast<uint32>(get_el2_ap1r0()); FALLTHROUGH;
                    case  0: break;
                }

                elrsr = static_cast<uint32>(get_el2_elrsr());
                vmcr  = static_cast<uint32>(get_el2_vmcr());
                hcr   = static_cast<uint32>(get_el2_hcr());
