...
class Dpt final : public Pte<Dpt, uint64_t, uint64_t>
{
    ...
    public:
        ...
        explicit constexpr Dpt() = default;
        explicit constexpr Dpt (Entry e) : Pte { e } {}
};

struct Dptp final : Ptab<Dpt, uint64_t, uint64_t>
{
    explicit constexpr Dptp() : Ptab { Dpt { 0 } } {}

    ~Dptp() { deallocate_root(); }
};
