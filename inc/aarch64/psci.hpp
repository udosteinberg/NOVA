...
class Psci : private Smc
{
    private:
        ...
        {
            return call (Call::SMC32, Service::SEC, static_cast<uint16>(f), p1, p2, p3);
        }

        ALWAYS_INLINE
        static inline auto invoke (Function64 f, uintptr_t &p1, uintptr_t &p2, uintptr_t &p3)
        {
            return call (Call::SMC64, Service::SEC, static_cast<uint16>(f), p1, p2, p3);
        }

        ALWAYS_INLINE
        static inline bool supported (Function32 f)
        {
            return features (fid (Call::SMC32, Service::SEC, static_cast<uint16>(f)));
        }

        ALWAYS_INLINE
        static inline bool supported (Function64 f)
        {
            return features (fid (Call::SMC64, Service::SEC, static_cast<uint16>(f)));
        }
        ...
        static inline auto version()
        {
            ...
            return static_cast<uint32>(invoke (Function32::PSCI_VERSION, zero, zero, zero));
        }
