...
class Console_uart_mmio_imx final : private Console_uart_mmio
{
    private:
        ...
        void init()
        {
            ...
            write (Register32::UBMR, modclock / g - 1);
        }

    public:
        Console_uart_mmio_imx (Hpt::OAddr p, unsigned c) : Console_uart_mmio (p), modclock (c)
        {
            if (!mmio_base)
                return;
