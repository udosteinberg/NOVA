...
class Console_uart_mmio_imx final : public Console_uart_mmio
{
    private:
        ...
        bool tx_busy() override final { return !(read (Register32::USR2) & BIT (3)); }
        bool tx_full() override final { return  (read (Register32::UTS)  & BIT (4)); }
        void tx (uint8 c) override final { write (Register32::UTXD, c); }
    ...
    protected:
        explicit Console_uart_mmio_imx (Hpt::OAddr p, unsigned c) : Console_uart_mmio (c) { mmap (p); }
