...
struct Board : Board_defaults
{
    ...
    static constexpr Uart uart { Debug::Subtype::SERIAL_NS16550_DBGP, 0x03100000, 0 };

    static constexpr struct Smmu_v2 { uint64_t mmio; struct { unsigned spi, flg; } glb[2], ctx[2]; } smmu_v2[1]
    {
