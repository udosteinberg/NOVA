...
class Sys_create_ec final : public Sys_regs
{
    public:
        ...
        unsigned cpu() const { return p2() & PAGE_MASK; }

        mword utcb() const { return p2() & ~PAGE_MASK; }
...
class Sys_create_sc final : public Sys_regs
{
    public:
        ...
        uint32 budget() const { return static_cast<uint32> (p3()) >> 12; }
...
class Sys_assign_dev final : public Sys_regs
{
    public:
        ...
        mword smmu() const { return p1() & ~PAGE_MASK; }
