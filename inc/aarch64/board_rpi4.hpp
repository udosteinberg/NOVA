/*
 * Board-Specific Memory Layout: Raspberry Pi 4
 *
...
#define FDTB_ADDR       0x3af4fb80

#define CL0_CORES       4
#define CL1_CORES       0
#define SPIN_ADDR       0xd8
#define SPIN_INCR       0x8
