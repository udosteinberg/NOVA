/*
 * Board-Specific Configuration: Raspberry Pi 4 (UEFI)
 *
...
struct Board
{
    ...
    static constexpr struct Uart { Uart_type type; uint64 mmio; unsigned clock; } uart = { Uart_type::PL011, 0xfe201000, 48000000 };
