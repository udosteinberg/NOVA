...
class Console_uart_scif final : private Console_uart
{
    private:
        ...
        auto read  (Register8  r) const    { return *reinterpret_cast<uint8  volatile *>(mmap + std::to_underlying (r)); }
        auto read  (Register16 r) const    { return *reinterpret_cast<uint16 volatile *>(mmap + std::to_underlying (r)); }
        void write (Register8  r, uint8  v) const { *reinterpret_cast<uint8  volatile *>(mmap + std::to_underlying (r)) = v; }
        void write (Register16 r, uint16 v) const { *reinterpret_cast<uint16 volatile *>(mmap + std::to_underlying (r)) = v; }
        ...
        inline void tx (uint8 c) const override final
        {
