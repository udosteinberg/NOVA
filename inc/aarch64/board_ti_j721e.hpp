...
struct Board
{
    ...
    static constexpr struct Smmu_v3 { uint64_t mmio; unsigned evt; unsigned glb; unsigned cmd; unsigned pri; } smmu_v3[1] { 0x36600000, Intid::from_spi (0x304), Intid::from_spi (0x300), 0, 0 };
};
