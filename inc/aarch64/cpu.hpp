...
class Cpu final
{
    private:
        ...
        static uint64_t feat_dbg64[3]       CPULOCAL;           // ID_AA64DFRx
    ...
    public:
        enum class Cpu_feature : unsigned
        {
            ...
            GCIE        = 35,   // FEAT_GCIE (1)
            UINJ        = 36,   // FEAT_UINJ (1)
            MTEEIRG     = 37,   // FEAT_MTE_EIRG (1)
            FGDT        = 38,   // FGDTIndex is 3 (0), 4 (1), 5 (2) bits wide
            MPAM2       = 39,   // FEAT_MPAMv2 (1)
            FPMR        = 40,   // FEAT_FPMR (1)
            VMTE        = 41,   // FEAT_VMTE (1), FEAT_VMTEE (2)
            VMTETC      = 42,   // FEAT_VMTETC (1)
            VMTETCL     = 43,   // FEAT_VMTETCL (1)
        };
        ...
        enum class Isa_feature : unsigned
        {
            ...
            LSFE        = 52,   // FEAT_LSFE (1)
            OCCMO       = 53,   // FEAT_OCCMO (1)
            LSUI        = 54,   // FEAT_LSUI (1)
            FPRCVT      = 55,   // FEAT_FPRCVT (1)
            PAC_FRAC2   = 56,   // FEAT_PAuth_EnhCtl (1)
            MTETC       = 57,   // FEAT_MTETC (1)
            LSCSHINT    = 58,   // FEAT_CMH (1)
            LSCP        = 59,   // FEAT_LSCP (1)
            HINTE       = 62,   // FEAT_HINTE (1)
        };
        ...
        enum class Mem_feature : unsigned
        {
            ...
            NV_FRAC     = 69,   // FEAT_NV2 (1), FEAT_NV2p1 (2), FEAT_NV3 (3)
            E2H0        = 70,   // FEAT_E2H0 (0)
            RMEGDI      = 71,   // FEAT_RME_GDI (1)
            EAESR       = 72,   // FEAT_EAESR (1)
            E3DSE       = 73,   // FEAT_E3DSE (1)
            TLBID       = 74,   // FEAT_TLBID (1)
            SRMASK      = 75,   // FEAT_SRMASK (1), FEAT_SRMASK2 (2)
            TPS         = 76,   // FEAT_TPS (1), FEAT_TPSP (2)
            TEV         = 77,   // FEAT_TEV (1)
            SCRX        = 78,   // FEAT_SCR2 (1)
            MTEFGT      = 79,   // FEAT_MTEFGT (1)
        };
        ...
        static auto remote_mpidr (cpu_t cpu) { return *Kmem::loc_to_glb (cpu, &mpidr); }

        static auto remote_ptab (cpu_t cpu) { return *Kmem::loc_to_glb (cpu, &ptab); }
