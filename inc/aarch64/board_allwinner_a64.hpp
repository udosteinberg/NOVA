...
struct Board
{
    ...
    static constexpr struct Gic { uint64_t mmio, size; } gic[4] { { 0x01c81000, 0x1000 }, { 0, 0 }, { 0x01c82000, 0x2000 }, { 0x01c84000, 0x2000 } };
    static constexpr struct Uart { Debug::Subtype type; uint64_t mmio; unsigned clock; } uart { Debug::Subtype::SERIAL_NS16550_NVIDIA, 0x01c28000, 0 };
