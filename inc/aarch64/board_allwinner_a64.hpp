...
struct Board
{
    ...
    static constexpr struct Gic { uint64 mmio, size; } gic[4] = { { 0x01c81000, 0x1000 }, { 0, 0 }, { 0x01c82000, 0x2000 }, { 0x01c84000, 0x2000 } };
    static constexpr struct Uart { Uart_type type; uint64 mmio; unsigned clock; } uart = { Uart_type::NS16550, 0x01c28000, 0 };
