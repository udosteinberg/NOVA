/*
 * Board-Specific Configuration: Xilinx Zynq Ultrascale+ MPSoC Ultra96
 *
...
struct Board
{
    ...
    static constexpr struct Uart { Debug::Subtype type; uint64_t mmio; unsigned clock; } uart { Debug::Subtype::SERIAL_CDNS, 0xff010000, 100'000'000 };
