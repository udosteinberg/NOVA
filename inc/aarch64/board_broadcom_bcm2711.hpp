...
struct Board
{
    ...
    static constexpr struct Uart { Uart_type type; uint64 mmio; unsigned clock; } uart { Uart_type::MINI, 0xfe215000, 500'000'000 };
//  static constexpr struct Uart { Uart_type type; uint64 mmio; unsigned clock; } uart { Uart_type::PL011, 0xfe201000, 48'000'000 };
