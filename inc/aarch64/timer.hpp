...
class Timer final : private Stc
{
    private:
        ...
        {
            /*
             * Reads of CNTPCT_EL0 can occur speculatively and out of order
             * relative to other instructions executed on the same PE.
             * ISB ensures the counter is not read prematurely.
             */
            uint64_t val;
