...
class Timer : private Stc
{
    ...
    public:
         ...
         */
        ALWAYS_INLINE
        static inline auto phys_to_syst (uint64 p) { return p - offs; }
         ...
         */
        ALWAYS_INLINE
        static inline auto syst_to_phys (uint64 s) { return s + offs; }
        ...
        {
            asm volatile ("msr cnthp_cval_el2, %0; isb" : : "r" (~0ULL));
        }
