...
class Smc
{
    private:
        ...
        {
            switch (static_cast<Service>(fid >> 24 & BIT_RANGE (5, 0))) {
                default:            return false;
                case Service::SIP:  return true;
                case Service::SEC:  return (BIT (19) | BIT (5)) & BIT (static_cast<uint16>(fid) >> 4);
            }
        }
    ...
    protected:
        ...
        {
            return BIT (31) | static_cast<uint32>(c) << 30 | static_cast<uint32>(s) << 24 | f;
        }
