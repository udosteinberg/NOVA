...
class Hpt : public Pte<Hpt, 4, 9, uint64, uint64>
{
    ...
    private:
        ...
        {
            return !(pm & (Paging::Permissions::XS | Paging::Permissions::W | Paging::Permissions::R)) ? 0 :
                     ATTR_nG *  !(pm & Paging::Permissions::G)  |
                     ATTR_K  * !!(pm & Paging::Permissions::K)  |
                     ATTR_U  * !!(pm & Paging::Permissions::U)  |
                     ATTR_nX *  !(pm & Paging::Permissions::XS) |
                     ATTR_nW *  !(pm & Paging::Permissions::W)  |
        ...
        static Paging::Permissions page_pm (OAddr a)
        {
            return Paging::Permissions (!a ? 0 :
                                      ...
                                      !!(a & ATTR_U)  * Paging::Permissions::U  |
                                       !(a & ATTR_nX) * Paging::Permissions::XS |
