...
class Space_dma final : public Space_mem<Space_dma>
{
    ...
    public:
        ...
        auto update (uint64_t v, uint64_t p, unsigned o, Paging::Permissions pm, Memattr ma, bool &inv) { return dptp.update (v, p, o, pm, ma, inv); }

        [[nodiscard]] auto sync() const { return true; }
};
