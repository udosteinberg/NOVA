/*
 * Board-Specific Configuration: ARM Fixed Virtual Platform
 *
...
struct Board
{
    ...
    static constexpr struct Gic { uint64 mmio, size; } gic[4] = { { 0x2f000000, 0x10000 }, { 0x2f100000, 0x100000 }, { 0x2c000000, 0x2000 }, { 0x2c010000, 0x2000 } };
    static constexpr struct Uart { Uart_type type; uint64 mmio; unsigned clock; } uart = { Uart_type::PL011, 0x1c090000, 0 };
