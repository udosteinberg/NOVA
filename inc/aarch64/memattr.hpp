...
#define MAIR_NOVA       (MAIR_ENC(CA_DEV,       CA_TYPE_DEV)        |   \
...
class Memattr final
{
    ...
    public:
        ...
        static constexpr auto gfx() { return Memattr { Share::NONE,  Cache::DEV_GRE }; }
        ...
        auto cache_s2() const
        {
            uint8_t attr = MAIR_NOVA >> (cache_s1() << 3) & BIT_RANGE (7, 0);
