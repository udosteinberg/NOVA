    ...
    private:
        ...
        class Queue
        {
            ...
            public:
                ...
                void produce (bool nc, Cmd const &cmd)
                {
                    ...
                    *p = cmd;
                    ...
                    Coherence::producer (nc, p, sizeof (*p));
                }

                void replace (bool nc, Cmd &cmd, index_t hwi) const
                {
        ...
        struct Table
        {
            ...
            public:
                [[nodiscard]] bool allocate (bool nc, unsigned o)
                {
                    ...
                    if (!v) [[unlikely]] {
                        ...
                        if (val.compare_exchange_n (v, BIT64 (63) | Kmem::ptr_to_phys (ptr))) [[likely]]
                            Coherence::producer (nc, this, sizeof (*this));
                        else
                            delete ptr;
                    }
                ...
                [[nodiscard]] static void *operator new (size_t, bool nc, unsigned o) noexcept
                {
                    ...
                    if (ptr) [[likely]]
                        Coherence::producer (nc, ptr, PAGE_SIZE (0) << o);
