...
class Gicc : private Intid
{
    ...
    private:
        ...
        static inline auto read  (Register32 r)    { return *reinterpret_cast<uint32 volatile *>(DEV_GLOBL_GICC + static_cast<unsigned>(r)); }
        static inline void write (Register32 r, uint32 v) { *reinterpret_cast<uint32 volatile *>(DEV_GLOBL_GICC + static_cast<unsigned>(r)) = v; }
