...
class Gicc final : private Intid
{
    ...
    private:
        ...
        static inline auto read  (Register32 r)      { return *reinterpret_cast<uint32_t volatile *>(MMAP_GLB_GICC + std::to_underlying (r)); }
        static inline void write (Register32 r, uint32_t v) { *reinterpret_cast<uint32_t volatile *>(MMAP_GLB_GICC + std::to_underlying (r)) = v; }
