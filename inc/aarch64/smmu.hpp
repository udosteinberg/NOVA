...
class Smmu final : public List<Smmu>
{
    private:
        ...
        uint8               ias             { 0 };              // IAddr Size
        uint8               oas             { 0 };              // OAddr Size
        ...
        Spinlock            tlb_lock;                           // SMMU TLB Lock
        ...
        inline auto read  (GR0_Register32 r)               { return *reinterpret_cast<uint32 volatile *>(mmio_base_gr0                         + std::to_underlying (r)); }
        inline auto read  (GR0_Register64 r)               { return *reinterpret_cast<uint64 volatile *>(mmio_base_gr0                         + std::to_underlying (r)); }
        inline auto read  (unsigned smg, GR0_Array32 r)    { return *reinterpret_cast<uint32 volatile *>(mmio_base_gr0 + smg * sizeof (uint32) + std::to_underlying (r)); }
        inline auto read  (unsigned ctx, GR1_Array32 r)    { return *reinterpret_cast<uint32 volatile *>(mmio_base_gr1 + ctx * sizeof (uint32) + std::to_underlying (r)); }
        inline auto read  (unsigned ctx, Ctx_Array32 r)    { return *reinterpret_cast<uint32 volatile *>(mmio_base_ctx + ctx * page_size       + std::to_underlying (r)); }
        inline auto read  (unsigned ctx, Ctx_Array64 r)    { return *reinterpret_cast<uint64 volatile *>(mmio_base_ctx + ctx * page_size       + std::to_underlying (r)); }

        inline void write (GR0_Register32 r,            uint32 v) { *reinterpret_cast<uint32 volatile *>(mmio_base_gr0                         + std::to_underlying (r)) = v; }
        inline void write (GR0_Register64 r,            uint64 v) { *reinterpret_cast<uint64 volatile *>(mmio_base_gr0                         + std::to_underlying (r)) = v; }
        inline void write (unsigned smg, GR0_Array32 r, uint32 v) { *reinterpret_cast<uint32 volatile *>(mmio_base_gr0 + smg * sizeof (uint32) + std::to_underlying (r)) = v; }
        inline void write (unsigned ctx, GR1_Array32 r, uint32 v) { *reinterpret_cast<uint32 volatile *>(mmio_base_gr1 + ctx * sizeof (uint32) + std::to_underlying (r)) = v; }
        inline void write (unsigned ctx, Ctx_Array32 r, uint32 v) { *reinterpret_cast<uint32 volatile *>(mmio_base_ctx + ctx * page_size       + std::to_underlying (r)) = v; }
        inline void write (unsigned ctx, Ctx_Array64 r, uint64 v) { *reinterpret_cast<uint64 volatile *>(mmio_base_ctx + ctx * page_size       + std::to_underlying (r)) = v; }
        ...
        void tlb_invalidate (unsigned, uint64);
