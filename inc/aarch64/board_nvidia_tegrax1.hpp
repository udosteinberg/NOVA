...
struct Board : Board_defaults
{
    ...
    static constexpr Gic gic[4] { { 0x50041000, 0x1000 }, { 0, 0 }, { 0x50042000, 0x2000 }, { 0x50044000, 0x2000 } };
    static constexpr Uart uart { Debug::Subtype::SERIAL_NS16550_DBGP, 0x70006000, 408'000'000 };
};
