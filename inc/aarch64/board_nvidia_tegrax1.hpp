...
struct Board
{
    ...
    static constexpr struct Gic { uint64 mmio, size; } gic[4] { { 0x50041000, 0x1000 }, { 0, 0 }, { 0x50042000, 0x2000 }, { 0x50044000, 0x2000 } };
    static constexpr struct Uart { Uart_type type; uint64 mmio; unsigned clock; } uart { Uart_type::NS16550, 0x70006000, 408'000'000 };
