...
class Console_uart_mmio_meson final : private Console_uart_mmio
{
    private:
        ...
        bool tx_busy() override final { return read (Register32::STAT) & BIT (25); }
        bool tx_full() override final { return read (Register32::STAT) & BIT (21); }
        void tx (uint8 c) override final { write (Register32::WBUF, c); }
    ...
    protected:
        explicit Console_uart_mmio_meson (Hpt::OAddr p, unsigned c) : Console_uart_mmio (c) { mmap (p); }
