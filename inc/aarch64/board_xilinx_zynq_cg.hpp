...
struct Board
{
    ...
    static constexpr struct Cpu { uint64 id; } cpu[2] { { 0x0 }, { 0x1 } };
    ...
    static constexpr struct Uart { Uart_type type; uint64 mmio; unsigned clock; } uart { Uart_type::CDNS, 0xff000000, 100'000'000 };
