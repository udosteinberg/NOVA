...
struct Board
{
    ...
    static constexpr struct Tmr { unsigned ppi, flg; } tmr[2] = { { 10, 0x4 }, { 11, 0x4 } };
    ...
    static constexpr struct Uart { Uart_type type; uint64 mmio; unsigned clock; } uart = { Uart_type::PL011, 0x9000000, 0 };
