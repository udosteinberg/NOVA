...
class Vmcb
{
    public:
        ...
        static uint64 const mdcr_hyp0 = MDCR_E2TB       |   // Trap trace buffer controls: TRB*
                                        MDCR_E2PB;          // Trap profiling buffer control: PMB*

        static uint64 const mdcr_hyp1 = MDCR_TDCC       |   // Trap debug comms channel: OSDTRRX, OSDTRTX, MDCCSR, MDCCINT, DBGDTR, DBGDTRRX, DBGDTRTX
