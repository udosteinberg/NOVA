...
class Vmcb final
{
    public:
        ...
        struct {                                    // GIC Registers
            uint64_t    lr  [Gich::max_lr]  {};     // List Registers
            uint32_t    ap0r[Gich::max_apr] {};     // Active Priorities Group 0 Registers
            uint32_t    ap1r[Gich::max_apr] {};     // Active Priorities Group 1 Registers
