...
class Console : public List<Console>
{
    ...
    protected:
        ...
        virtual bool match_dbgp (Debug::Type, Debug::Subtype) const { return false; }
        virtual bool using_regs (Acpi_gas const &) const            { return false; }
        virtual bool setup_regs (Acpi_gas const &)                  { return false; }
