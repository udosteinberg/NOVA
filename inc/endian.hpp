 ...
 * Sanity checks
 */
static_assert (sizeof (uint64_t) == sizeof (Aligned  <uint64_t, false>));
static_assert (sizeof (uint64_t) == sizeof (Aligned  <uint64_t, true>));
static_assert (sizeof (uint64_t) == sizeof (Unaligned<uint64_t, false>));
static_assert (sizeof (uint64_t) == sizeof (Unaligned<uint64_t, true>));
static_assert (std::trivially_constructible<Aligned  <uint64_t, false>>);
static_assert (std::trivially_constructible<Aligned  <uint64_t, true>>);
static_assert (std::trivially_constructible<Unaligned<uint64_t, false>>);
static_assert (std::trivially_constructible<Unaligned<uint64_t, true>>);
static_assert (std::trivially_copyable     <Aligned  <uint64_t, false>>);
static_assert (std::trivially_copyable     <Aligned  <uint64_t, true>>);
static_assert (std::trivially_copyable     <Unaligned<uint64_t, false>>);
