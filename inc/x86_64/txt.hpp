...
class Txt final
{
    private:
        ...
        struct Element
        {
            ...
            auto get_next() const { return std::start_lifetime_as<Element const> (reinterpret_cast<uintptr_t>(this) + size); }
        ...
        struct Data_efi_pre
        {
            ...
            auto elem() const { return version < 4 ? nullptr : std::start_lifetime_as<Element const> (this + 1); }
        };
        ...
        struct Data_pre_acm
        {
            ...
            auto elem() const { return version < 6 ? nullptr : std::start_lifetime_as<Element const> (this + 1); }
        };
        ...
        struct Data_acm_mle
        {
            ...
            auto elem() const { return version < 8 ? nullptr : std::start_lifetime_as<Element const> (this + 1); }
        };
