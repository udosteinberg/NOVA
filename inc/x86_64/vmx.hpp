...
class Vmcs
{
    private:
        ...
        static inline void vmxon()
        {
            ...
            bool ret;
            asm volatile ("vmxon %1" : "=@cca" (ret) : "m" (phys));
            assert (ret);
        }
    ...
    public:
        ...
        enum Ctrl_cpu_3
        {
            CPU_LOADIWKEY           = BIT  (0),
            CPU_HLAT                = BIT  (1),
            CPU_EPT_WRITE_CTRL      = BIT  (2),
            CPU_GUEST_PG_VERIFY     = BIT  (3),
            CPU_IPI_VIRT            = BIT  (4),
            CPU_GPAW                = BIT  (5),
        };
        ...
        ALWAYS_INLINE
        inline Vmcs() : rev (basic.revision), abort (0) {}
        ...
        static bool has_mbec()  { return ctrl_cpu[1].clr & CPU_MBEC; }
