...
class Pd_kern final : private Pd
{
    private:
        ...
        void update_user_pio (mword, mword, bool);
    ...
    public:
        ...
        static inline void insert_user_pio (mword p, mword s) { singleton.update_user_pio (p, s, true);  }
        static inline void remove_user_pio (mword p, mword s) { singleton.update_user_pio (p, s, false); }
};
