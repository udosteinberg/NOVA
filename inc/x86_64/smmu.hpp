    ...
    private:
        ...
        class Entry_ctx final
        {
            ...
            public:
                ...
                auto addr() const { return lo & ~OFFS_MASK; }
        ...
        inline auto read  (Register32 r) const    { return *reinterpret_cast<uint32_t volatile *>(mmio_base         + std::to_underlying (r)); }
        inline auto read  (Register64 r) const    { return *reinterpret_cast<uint64_t volatile *>(mmio_base         + std::to_underlying (r)); }
        inline auto read  (Tlb64      r) const    { return *reinterpret_cast<uint64_t volatile *>(mmio_base + iro() + std::to_underlying (r)); }

        inline void write (Register32 r, uint32_t v) const { *reinterpret_cast<uint32_t volatile *>(mmio_base         + std::to_underlying (r)) = v; }
        inline void write (Register64 r, uint64_t v) const { *reinterpret_cast<uint64_t volatile *>(mmio_base         + std::to_underlying (r)) = v; }
        inline void write (Tlb64      r, uint64_t v) const { *reinterpret_cast<uint64_t volatile *>(mmio_base + iro() + std::to_underlying (r)) = v; }
         ...
         */
        void ri_inv_tlb (uint16_t did) const
        {
         ...
         */
        void ri_inv_ctx (uint16_t did) const
        {
         ...
         */
        void ri_inv_ctx (uint16_t sid, uint16_t did) const
        {
         ...
         */
        void invalidate_tlb (uint16_t did)
        {
            Lock_guard <Spinlock> guard { inv_lock };
         ...
         */
        void invalidate_ctx (uint16_t did)
        {
            Lock_guard <Spinlock> guard { inv_lock };
         ...
         */
        void invalidate_ctx (uint16_t sid, uint16_t did)
        {
            Lock_guard <Spinlock> guard { inv_lock };
         ...
         */
        void invalidate_iec (uint16_t idx)
        {
            assert (ir && has_qi());    // IR support implies QI support
