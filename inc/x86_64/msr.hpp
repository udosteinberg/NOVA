...
class Msr
{
    public:
        ...
        static inline auto read  (Array r, unsigned b, unsigned n)     { return read (static_cast<Register>(static_cast<unsigned>(r) + b * n)); }
        static inline void write (Array r, unsigned b, unsigned n, uint64 v) { write (static_cast<Register>(static_cast<unsigned>(r) + b * n), v); }
};
