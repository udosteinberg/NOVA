...
class Msr
{
    public:
        ...
        enum Register
        {
            ...
            IA32_VMX_CTRL_CPU_PRI       = 0x482,
            IA32_VMX_CTRL_EXI_PRI       = 0x483,
            IA32_VMX_CTRL_ENT           = 0x484,
            ...
            IA32_VMX_CTRL_CPU_SEC       = 0x48b,
            IA32_VMX_EPT_VPID           = 0x48c,
            IA32_VMX_TRUE_PIN           = 0x48d,
            IA32_VMX_TRUE_CPU           = 0x48e,
            IA32_VMX_TRUE_EXI           = 0x48f,
            IA32_VMX_TRUE_ENT           = 0x490,
