...
class Barrier final
{
    public:
         ...
         */
        ALWAYS_INLINE static void rmb() { asm volatile ("lfence" : : : "memory"); }
         ...
         * CLFLUSH -->|         |<-- CLFLUSH
         */
        ALWAYS_INLINE static void wmb() { asm volatile ("sfence" : : : "memory"); }
         ...
         * CLFLUSH -->|         |<-- CLFLUSH
         */
        ALWAYS_INLINE static void fmb() { asm volatile ("mfence" : : : "memory"); }
};
