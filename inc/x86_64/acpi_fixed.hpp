...
class Acpi_fixed final
{
    ...
    private:
        /*
         * 4.8.2.1: Power Management Timer (3.579545 MHz)
         */
        ...
        {
            PM1_STS,        // rw   PM1 Status
            PM1_ENA,        // rw   PM1 Enable
            PM1_CNT,        // rw   PM1 Control
            PM2_CNT,        // rw   PM2 Control
            PM_TMR,         // r-   PM Timer
            RST_REG,        // -w   Reset
            SLP_CNT,        // -w   Sleep Control
            SLP_STS,        // rw   Sleep Status
        };
        ...
        static inline unsigned read (Register r)
        {
            switch (r) {
                ...
                case Register::SLP_STS: return read (slp_sts);
                default: return 0;  // RST_REG and SLP_CNT are write-only
            }
        }
        ...
        static inline void write (Register r, unsigned v)
        {
            switch (r) {
                ...
                case Register::SLP_CNT: write (slp_cnt,  v);                      break;
                case Register::SLP_STS: write (slp_sts,  v);                      break;
                default: break;     // PM_TMR is read-only
            }
        }
    ...
    public:
        ...
        static bool sleep (Transition t)
        {
            ...
            if (slp_cnt.valid())
                write (Register::SLP_CNT, BIT (5) | t.val_a() << 2);
            else {
