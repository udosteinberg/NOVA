...
class Cos final
{
    ...
    private:
        ...
        static inline void set_cos (cos_t cos) { Msr::write (Msr::Reg64::IA32_PQR_ASSOC, static_cast<uint64_t>(cos) << 32); }

        static inline void set_l3_mask (uint16_t n, uint32_t val) { Msr::write (Msr::Arr64::IA32_L3_MASK, 1, n, val); }
        static inline void set_l2_mask (uint16_t n, uint32_t val) { Msr::write (Msr::Arr64::IA32_L2_MASK, 1, n, val); }
        static inline void set_mb_thrt (uint16_t n, uint16_t val) { Msr::write (Msr::Arr64::IA32_MB_THRT, 1, n, val); }
