...
class Console_uart_pio_ns16550 : private Console_uart_pio
{
    private:
        ...
        inline auto read  (Register8 r)   { return Io::in <uint8>(port_base + std::to_underlying (r)); }
        inline void write (Register8 r, uint8 v) { Io::out<uint8>(port_base + std::to_underlying (r), v); }
