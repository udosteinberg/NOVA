...
class Acpi_table_dmar final
{
    private:
        ...
        static_assert (__is_standard_layout (Scope) && sizeof (Scope) == 8);
        ...
        static_assert (__is_standard_layout (Remapping) && sizeof (Remapping) == 4);
        ...
        static_assert (sizeof (Remapping_drhd) == 16);
        ...
        static_assert (sizeof (Remapping_rmrr) == 24);
