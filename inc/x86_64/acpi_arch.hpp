    ...
    protected:
        ...
        static void parse_tables (bool &ret)
        {
            ...
            if ((ptr = Acpi_table::map (hpet, 0))) [[likely]]
                ret &= static_cast<Acpi_table_hpet const *>(ptr)->parse();
            if ((ptr = Acpi_table::map (dmar, 0))) [[likely]]
                ret &= static_cast<Acpi_table_dmar const *>(ptr)->parse();
            if ((ptr = Acpi_table::map (ivrs, 0))) [[likely]]
                ret &= static_cast<Acpi_table_ivrs const *>(ptr)->parse();
            if ((ptr = Acpi_table::map (lpit, 0))) [[likely]]
                ret &= static_cast<Acpi_table_lpit const *>(ptr)->parse();
        }
        ...
        static inline constinit uint64_t dbg2 {}, dmar {}, facs {}, fadt {}, hest {}, hpet {}, ivrs {}, lpit {}, madt {}, mcfg {}, spcr {}, srat {}, tpm2 {}, xsdt {};
