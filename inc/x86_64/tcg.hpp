...
class Tcg
{
    ...
    protected:
        ...
        struct Tpm12_pcr_extend : public Cmd
        {
            ...
            explicit Tpm12_pcr_extend (unsigned pcr, Hash_sha1_160 const &h) : Cmd { Tpm_st::Type::RQU_COMMAND, sizeof (*this), Tpm_cc::Type::V1_PCR_EXTEND }, pidx { pcr } { h.serialize (sha1_160); }
        };

        static_assert (sizeof (Tpm12_pcr_extend) == sizeof (Cmd) + sizeof (uint32_t) + Hash_sha1_160::digest);
        ...
        struct Tpm20_pcr_extend : public Cmd
        {
            ...
            explicit Tpm20_pcr_extend (unsigned pcr, Hash_sha1_160 const &h) : Cmd { Tpm_st::Type::ST_SESSIONS, sizeof (*this) - sizeof (digest) + sizeof (digest.sha1_160), Tpm_cc::Type::V2_PCR_EXTEND }, hpcr { Tpm_handle { Tpm_handle::Type::HT_PCR, pcr } }, halg { Tpm_alg::Type::SHA1_160 } { h.serialize (digest.sha1_160); }
            explicit Tpm20_pcr_extend (unsigned pcr, Hash_sha2_256 const &h) : Cmd { Tpm_st::Type::ST_SESSIONS, sizeof (*this) - sizeof (digest) + sizeof (digest.sha2_256), Tpm_cc::Type::V2_PCR_EXTEND }, hpcr { Tpm_handle { Tpm_handle::Type::HT_PCR, pcr } }, halg { Tpm_alg::Type::SHA2_256 } { h.serialize (digest.sha2_256); }
            explicit Tpm20_pcr_extend (unsigned pcr, Hash_sha2_384 const &h) : Cmd { Tpm_st::Type::ST_SESSIONS, sizeof (*this) - sizeof (digest) + sizeof (digest.sha2_384), Tpm_cc::Type::V2_PCR_EXTEND }, hpcr { Tpm_handle { Tpm_handle::Type::HT_PCR, pcr } }, halg { Tpm_alg::Type::SHA2_384 } { h.serialize (digest.sha2_384); }
            explicit Tpm20_pcr_extend (unsigned pcr, Hash_sha2_512 const &h) : Cmd { Tpm_st::Type::ST_SESSIONS, sizeof (*this) - sizeof (digest) + sizeof (digest.sha2_512), Tpm_cc::Type::V2_PCR_EXTEND }, hpcr { Tpm_handle { Tpm_handle::Type::HT_PCR, pcr } }, halg { Tpm_alg::Type::SHA2_512 } { h.serialize (digest.sha2_512); }
        };
