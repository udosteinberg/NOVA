...
class Capability final
{
    ...
    public:
        ...
        void publish() const
        {
            ...
            // Acquire reference
            auto const r { o->ref_inc() };

            // Reference count 0 -> 1 because nobody has seen the object yet
            assert (r == 1);
        }
        ...
        void retract() const
        {
            ...
            // Release reference
            auto const r { o->ref_dec() };

            // Reference count 1 -> 0 because nobody has seen the object yet
            assert (r == 0);
        }
