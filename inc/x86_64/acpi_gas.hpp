...
class Acpi_gas final
{
    public:
        ...
        Unaligned_le<uint8_t>   bits { 0 };     // Number of bits in the given register (0=non-existent)
        Unaligned_le<uint8_t>   offs { 0 };     // Bit offset of the given register at the given address
        Unaligned_le<uint8_t>   accs { 0 };     // Access size (0=undefined, 1=8bit, 2=16bit, 3=32bit, 4=64bit)
        Unaligned_le<uint64_t>  addr { 0 };     // Address of the data structure or register in the given address space
