...
class Fpu final
{
    ...
    public:
        ...
        static constexpr uint64_t desired { Component::AVX512 | Component::AVX | Component::SSE | Component::X87 };
        ...
        {
            asm volatile (EXPAND (PATCH (xrstors64 %0, xrstor64 %0, PATCH_XSAVES)) : : "m" (*this), "d" (static_cast<uint32_t>(desired >> 32)), "a" (static_cast<uint32_t>(desired)));
        }
        ...
        inline void save()
        {
            asm volatile (EXPAND (PATCH (xsaves64 %0, xsave64 %0, PATCH_XSAVES)) : "=m" (*this) : "d" (static_cast<uint32_t>(desired >> 32)), "a" (static_cast<uint32_t>(desired)));
        }
