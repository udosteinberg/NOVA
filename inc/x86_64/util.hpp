...
template<typename T> [[nodiscard]] auto view_buffer_as (uintptr_t b, size_t s, size_t o, unsigned n = 1)
{
    return o > s || n * sizeof (T) > s - o ? nullptr : std::start_lifetime_as_array<T> (b + o, n);
}
