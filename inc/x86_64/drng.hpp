...
class Drng final
{
    private:
         ...
         */
        [[nodiscard]] static bool rand (uint64 &v)
        {
            unsigned retries { 16 };
         ...
         */
        [[nodiscard]] static bool seed (uint64 &v)
        {
            unsigned retries { 16 };
    ...
    public:
        static bool rand (uint64 (&v)[], unsigned const n)
        {
        ...
        static bool seed (uint64 (&v)[], unsigned const n)
        {
